...
public class complainerHomeFragment extends Fragment implements complainerAdapterTasks.OnItemClickListener {
    ...
    complainerAdapterTasks complaineradapterTasks;
    ProgressBar progressBar;

    public complainerHomeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_complainer_home, container, false);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds:dataSnapshot.getChildren()){
                    ...
                    complaineradapterTasks = new complainerAdapterTasks(getActivity(),taskList);
                    // set adapter to recyclerview
                    recyclerView.setAdapter(complaineradapterTasks);

                    //------------
                    complaineradapterTasks.setOnItemClickListener(complainerHomeFragment.this);

                    complaineradapterTasks.notifyDataSetChanged();
...
//        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.action_add_complaint){
            startActivity(new Intent(getActivity(), complainerAddComplaintActivity.class));
        }
...
//
//        reportIntent.putExtra(EXTRA_ID,clickedItem.getpId()).toString();
//
