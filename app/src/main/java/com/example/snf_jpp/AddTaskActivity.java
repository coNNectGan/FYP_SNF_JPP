    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              String description = titleEt.getText().toString().trim();
              if (TextUtils.isEmpty(title)){
                  Toast.makeText(AddTaskActivity.this,"Enter title...", Toast.LENGTH_SHORT).show();
                  return;

              }

              if (TextUtils.isEmpty(description)){
                  Toast.makeText(AddTaskActivity.this,"Enter description...", Toast.LENGTH_SHORT).show();
                  return;
              }
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()) {
                                ...
                                hashMap.put("pDecor",description);
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                //added in database
                                                pd.dismiss();
                                                Toast.makeText(AddTaskActivity.this,"Post published",Toast.LENGTH_SHORT).show();
                                                //reset views
                                                titleEt.setText("");
