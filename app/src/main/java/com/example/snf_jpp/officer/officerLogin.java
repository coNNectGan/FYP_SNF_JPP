package com.example.snf_jpp.officer;
...
public class officerLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Officer Login Page");
        //enable back button
        ...
        loginOfficer = findViewById(R.id.BTNLogin);
        ...
        //login button click
        //----------------------------------------------------------------------------------------------------------------------
        loginOfficer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //input data
...
//                startActivity(new Intent(officerLogin.this, DashBoardActivity.class));
            }
        });
        //----------------------------------------------------------------------------------------------------------------------
    ...
    private void beginRecovery(String staffid) {
        ...
        mAuth.sendPasswordResetEmail(staffid)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()){
                            Toast.makeText(officerLogin.this,"Email sent", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            Toast.makeText(officerLogin.this,"Failed...", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(officerLogin.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
    }
    //----------------------------------------------------------------------------------------------------------------------
...
//Get user email and uid from auth
                                ...
                                DatabaseReference reference = database.getReference("Officer");
                            ...
                            Toast.makeText(officerLogin.this, "Authentication failed.",
        ...
        dbRef.child(FirebaseAuth.getInstance().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (userType != null && userType.equals("officer")) {
                    Toast.makeText(officerLogin.this, "Login success.",
                            Toast.LENGTH_SHORT).show();
                    //user is logged in, so start loginactivity
                    startActivity(new Intent(officerLogin.this, officerDashBoard.class));
                    ...
                    Toast.makeText(officerLogin.this, "Login fail!Please make choose correct user types.",
                            Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(officerLogin.this, "" + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
