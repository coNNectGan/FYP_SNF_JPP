...
import com.example.snf_jpp.complainer.complainerHomeFragment;
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()){
                        ...
                        case R.id.nav_complaintC:
                            ...
                            //home fragment transaction
//                            actionBar.setTitle("Complaint"); // change action title
...
//            ProfileTv.setText(user.getEmail());
            ...
            startActivity(new Intent(officerDashBoard.this, MainActivity.class));
            finish();
        }
    }
